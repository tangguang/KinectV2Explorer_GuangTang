...
static const int CameraSettingMenuPosition          = 3;
static const int RecordingMenuPosition              = 5;
static const int RecordingFTModelMenuPosition       = 6;
static const int SpeechRecognitionMenuPosition      = 7;
static const int ExercisesMenuPosition              = 8;
static const int InBedDetectionMenuPosition         = 9;
...
static const int RecordingAudioMenuPosition         = 0;
static const int RecordingRGBMenuPosition           = 1;
static const int RecordingDepthMenuPosition         = 2;
static const int RecordingAllMenuPosition           = 3;
static const int StandMoveLegOutWardsMenuPosition   = 0;
static const int StandHandsOnWallMenuPosition       = 1;
static const int StandHeelOnTableMenuPosition       = 2;
static const int StandArmsLiftWeightsMenuPosition   = 3;
static const int StandRaisingheelsMenuPosition      = 4;
static const int SitBentLegTo90DegreesMenuPosition  = 5;
static const int SitToStandMenuPosition             = 6;
...
DWORD WINAPI KinectWindow::ThreadProc(KinectWindow* pThis)
{
    ...
    if (pThis->Initialize() && pThis->CreateWindows())
    {
        ...
        pThis->StartStreams();
		// CreateThread(NULL, 0, FaceRecogStaticThread, (PVOID)pThis, 0, 0);
...
//DWORD WINAPI KinectWindow::SpeechRecogStaticThread(PVOID lpParam)
//{
//	KinectWindow* context = static_cast<KinectWindow*>(lpParam);
//	if (context)
//	{
//		CSimpleDict* pSimpleDict;
//		context->GetSimpleDict(&pSimpleDict);
//		return pSimpleDict->SpeechRecogThread();
//	}
//	return 0;
//}
