...
public:
    ...
    KinectSettings(INuiSensor* pNuiSensor, NuiStreamViewer* pPrimaryView, NuiStreamViewer* pSecondarView, NuiColorStream* pColorStream, 
		NuiDepthStream* pDepthStream, NuiAudioStream* pAudioStream, NuiSkeletonStream* pSkeletonStream, CameraSettingsViewer* pColorSettingsView, 
