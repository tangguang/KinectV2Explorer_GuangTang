...
void ImageRenderer::CreateSolidBrushes()
{
	...
	CreateSolidBrush(D2D1::ColorF::Red,         ImageRendererBrushRed);
	CreateSolidBrush(D2D1::ColorF::WhiteSmoke,  ImageRendererBrushWhiteSomke);
	CreateSolidBrush(D2D1::ColorF::HotPink,     ImageRendererBrushHotPink);
}
...
{
    CreateTextFormat(L"Segoe UI", 40.0f, DWRITE_TEXT_ALIGNMENT_CENTER,  DWRITE_PARAGRAPH_ALIGNMENT_CENTER, &m_formats[ImageRendererTextFormatFps]);        // FPS text format
